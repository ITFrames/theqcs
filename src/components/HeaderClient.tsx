...
/**
 * HeaderClient — the interactive shell of the site header (mobile menu, scroll
 * styling, logout). Auth state is resolved on the SERVER and passed in as
 * `initialAuthed`, so the correct Login/Register (or Dashboard/Sign out)
 * buttons are in the initial HTML with no flash or fetch delay on load.
 */
