...
const socialLinks = [
  { icon: Facebook, href: "https://www.facebook.com/qcsabroad", label: "Facebook" },
  { icon: Instagram, href: "https://www.instagram.com/qcsabroad", label: "Instagram" },
  { icon: Linkedin, href: "https://www.linkedin.com/company/qcsabroad", label: "LinkedIn" },
  { icon: Twitter, href: "https://x.com/qcsabroad", label: "X (Twitter)" },
  { icon: MessageCircle, href: "https://wa.me/16478903806?text=Hi+QCS+ABROAD%21+%F0%9F%91%8B%0A%0AI%27m+interested+in+studying+abroad+and+would+like+guidance+with+my+application.%0A%0A%F0%9F%8C%8D+Preferred+Country%3A%0A%F0%9F%8E%93+Program+%2F+Course%3A%0A%F0%9F%93%9A+Current+Qualification%3A%0A%F0%9F%93%85+Preferred+Intake%3A%0A%0APlease+help+me+understand+my+study+options+and+the+next+steps.%0A%0AThank+you%21", label: "WhatsApp" },
];
...
export default function ContactPage() {
  ...
  return (
    <div>
      {/* Page Header */}
      <section className="relative bg-[var(--color-primary)] text-white py-20 lg:py-24">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 max-w-2xl mx-auto text-lg text-white/85 leading-relaxed">
            ...
            Reach out to our team and let&apos;s start planning your future
            together.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-3">
                  ...
                  */}
                  ...
                  <div className="grid gap-6 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="mt-2 block w-full rounded-lg border border-[var(--color-border)] bg-white px-4 py-3 text-sm text-[var(--color-foreground)] placeholder:text-[var(--color-foreground-subtle)] focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/20 transition-all duration-200"
                      />
                    </div>
                  ...
                  <div className="grid gap-6 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        required
                        defaultValue=""
                        className="mt-2 block w-full rounded-lg border border-[var(--color-border)] bg-white px-4 py-3 text-sm text-[var(--color-foreground)] focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/20 transition-all duration-200"
                      >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="mt-2 block w-full rounded-lg border border-[var(--color-border)] bg-white px-4 py-3 text-sm text-[var(--color-foreground)] placeholder:text-[var(--color-foreground-subtle)] focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/20 transition-all duration-200 resize-y"
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="btn btn-primary px-8 py-3 text-base disabled:opacity-60 disabled:cursor-not-allowed"
                  >
            ...
            <div className="space-y-8">
              {/* Contact Info */}
              <div className="rounded-xl bg-[var(--color-background-alt)] border border-[var(--color-border-light)] p-6">
                  ...
                  {contactInfo.map((item) => (
                    <div key={item.label} className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-sm text-[var(--color-foreground-muted)] whitespace-pre-line">
                          {item.value}
                        </p>
                      </div>
                    </div>
                ...
                <div className="mt-4 flex gap-3">
                  {socialLinks.map((social) => (
                    <a
                      ...
                      className="flex h-10 w-10 items-center justify-center rounded-lg bg-[var(--color-primary)] text-white hover:bg-[var(--color-primary-light)] transition-colors duration-200"
                    >
