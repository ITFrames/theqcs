...
function rowToProfile(r: any): StudentProfile {
  return {
    ...
    graduationYearFrom: r.graduation_year_from ?? undefined,
    graduationYearTo: r.graduation_year_to ?? undefined,
    grade: r.grade ?? undefined,
    englishTest: r.english_test ?? undefined,
    englishScore: r.english_score ?? undefined,
    englishTests: r.english_tests ?? undefined,
    englishScores: r.english_scores ?? undefined,
    hasMasters: r.has_masters ?? undefined,
    mastersInstitution: r.masters_institution ?? undefined,
    mastersField: r.masters_field ?? undefined,
    mastersGraduationYear: r.masters_graduation_year ?? undefined,
    mastersGrade: r.masters_grade ?? undefined,
...
function profileToRow(userId: string, p: Partial<StudentProfile>) {
  return {
    ...
    graduation_year_from: p.graduationYearFrom ?? null,
    graduation_year_to: p.graduationYearTo ?? null,
    grade: p.grade ?? null,
    english_test: p.englishTest ?? null,
    english_score: p.englishScore ?? null,
    english_tests: p.englishTests ?? null,
    english_scores: p.englishScores ?? null,
    has_masters: p.hasMasters ?? null,
    masters_institution: p.mastersInstitution ?? null,
    masters_field: p.mastersField ?? null,
    masters_graduation_year: p.mastersGraduationYear ?? null,
    masters_grade: p.mastersGrade ?? null,
